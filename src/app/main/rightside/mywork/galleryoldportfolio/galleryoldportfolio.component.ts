...
@Component({
  selector: 'app-galleryoldportfolio',
  templateUrl: './galleryoldportfolio.component.html',
  styleUrls: ['./galleryoldportfolio.component.scss']
})
export class GalleryoldportfolioComponent implements OnInit {
